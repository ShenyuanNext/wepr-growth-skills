...
def main():
    parser = argparse.ArgumentParser(description="Serve wepr-geoflow-design preview files.")
    ...
    with socketserver.TCPServer(("127.0.0.1", args.port), handler) as httpd:
        ...
        print(f"Preview URL: http://127.0.0.1:{args.port}/preview/wepr-editorial-20260418/index.html")
        httpd.serve_forever()
