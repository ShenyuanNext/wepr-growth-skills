...
Use `python3 scripts/bento_deck.py inject <deck.bento.html> <document.json>`
for deterministic replacement and `python3 scripts/bento_deck.py validate
...
7. **Validate** with `scripts/bento_deck.py validate`, then open the file in a
