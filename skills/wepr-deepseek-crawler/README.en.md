...
`wepr-deepseek-crawler` turns repeated DeepSeek web AI-search samples into GEO probability evidence. It uses a local OpenCLI Browser Bridge and an already logged-in DeepSeek web session, preserves raw evidence, and generates structured Markdown, Excel, and Kami-styled HTML diagnostic reports.
