...
A lightweight SEO agent skill designed for quick, default single-page SEO audits. Suitable for first-time page checks or when a rapid assessment is needed without full technical depth.
