...
- 全站品牌、竞品、信源和 AI 答案样本诊断；应改用 `wepr-geo-panorama-audit`。
- GEO 后端效果归因、埋点或追踪闭环；应改用 `wepr-geo-tracking`。
...
14. 如需文件交付，使用 `scripts/render_wepr_geo_page_blueprint.py` 从 `report_input.json` 生成 Markdown、HTML、Word、PDF。
