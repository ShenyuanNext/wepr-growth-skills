...
This reference is intentionally short. The full current frontend map lives in `wepr-geoflow-design`.
...
If these current signals exist, route the task to `wepr-geoflow-design`.
