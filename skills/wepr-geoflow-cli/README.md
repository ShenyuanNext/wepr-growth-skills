...
`wepr-geoflow-cli` operates an existing GEOFlow 2.1+ system through the local project CLI, Laravel API v1 fallback, or authenticated admin web flows. It is for production operations, not product-code implementation.
