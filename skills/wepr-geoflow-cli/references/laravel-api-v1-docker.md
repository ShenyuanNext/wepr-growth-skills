...
```bash
skills/wepr-geoflow-cli/scripts/geoflow_preflight.sh "/path/to/GEOFlow"
```

For material work:

```bash
skills/wepr-geoflow-cli/scripts/geoflow_preflight.sh "/path/to/GEOFlow" "" catalog,materials
```

For admin-web work:

```bash
skills/wepr-geoflow-cli/scripts/geoflow_preflight.sh "/path/to/GEOFlow" "" admin
```
